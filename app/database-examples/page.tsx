...
export default async function DatabaseExamplesPage() {
  ...
  return (
    <div
      style={{ padding: "2rem", fontFamily: "monospace", maxWidth: "1200px" }}
    >
      ...
      <section style={{ marginBottom: "2rem" }}>
        ...
        >
          <p>
            <strong>Total Invoices:</strong> {stats[0].total_invoices}
          </p>
          <p>
            <strong>Total Amount:</strong> $
            {(Number(stats[0].total_amount) / 100).toFixed(2)}
          </p>
          <p>
            <strong>Average Amount:</strong> $
            {(Number(stats[0].average_amount) / 100).toFixed(2)}
          </p>
          <p>
            <strong>Max Amount:</strong> $
            {(Number(stats[0].max_amount) / 100).toFixed(2)}
          </p>
          <p>
            <strong>Min Amount:</strong> $
            {(Number(stats[0].min_amount) / 100).toFixed(2)}
          </p>
        </div>
      </section>
