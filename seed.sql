...
-- Insert user (password is bcrypt hash of '123456')
INSERT INTO users (id, name, email, password)
VALUES ('410544b2-4001-4271-9855-fec4b6a6442a', 'User', 'user@nextmail.com', '$2a$10$K7L1OJ45/4Y2nIvhRVpCe.FSmhDdWoXehVzJptJ/op0lSsvqNu/1u')
